...
const AppContent: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'today':
        return <Today setActivePage={navigateTo} leads={leads} listings={listings} goals={goals} />;
      case 'leads':
        return <Leads leads={leads} setLeads={setLeads} isLoading={isLoading} />;
      case 'listings':
      ...
      case 'tools':
        return <Tools />;
      case 'settings':
        return <Settings goals={goals} onUpdateGoals={setGoals} />;
      default:
        return <Today setActivePage={navigateTo} leads={leads} listings={listings} goals={goals} />;
    }
  };
  ...
  return (
    <div className="md:flex h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <BottomNavBar currentPage={currentPage} setCurrentPage={navigateTo} />
      </div>
    </div>
  );
};
