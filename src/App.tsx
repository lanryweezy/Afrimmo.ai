...
const mockLeadsData: Omit<Lead, 'score' | 'temperature' | 'justification' | 'nextAction'>[] = [
    ...
    { id: '4', name: 'Fatima Bello', status: 'Offer', source: 'WhatsApp', 
        ...
        conversation: [
           // FIX: Corrected typo `sender:ai'` to `sender: 'ai'`
...
const mockListingsData: Listing[] = [
    { id: '1', address: '12 Banana Island Rd, Ikoyi, Lagos', price: '₦850,000,000', status: 'Available', imageUrl: 'https://picsum.photos/seed/house1/400/300', beds: 5, baths: 6, size: 700 },
    { id: '2', address: '8A Admiralty Way, Lekki Phase 1, Lagos', price: '₦450,000,000', status: 'Under Offer', imageUrl: 'https://picsum.photos/seed/house2/400/300', beds: 4, baths: 5, size: 550 },
    { id: '3', address: '25 Opebi Rd, Ikeja, Lagos', price: '₦180,000,000', status: 'Available', imageUrl: 'https://picsum.photos/seed/house3/400/300', beds: 4, baths: 4, size: 480 },
    { id: '4', address: 'Estate 5, VGC, Lagos', price: '₦320,000,000', status: 'Sold', imageUrl: 'https://picsum.photos/seed/house4/400/300', beds: 5, baths: 5, size: 600 },
];
