...
import { PropertyValuatorIcon, MarketInsightsIcon, VideoIcon } from './IconComponents';

type Tool = 'valuator' | 'insights' | 'video-studio';
             ...
             <div className="space-y-6 text-center animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    <button onClick={() => setActiveTool('valuator')} className="text-left w-full h-full">
                        <Card className="hover:bg-gray-700 hover:border-teal-500 border-2 border-transparent transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
